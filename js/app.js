var app = function (exports) {
    ...
    }, nativeExec = RegExp.prototype.exec, nativeReplace = String.prototype.replace, patchedExec = nativeExec, LAST_INDEX = "lastIndex", UPDATES_LAST_INDEX_WRONG = (ha = /a/, ia = /b*/g, nativeExec.call(ha, "a"), nativeExec.call(ia, "a"), 0 !== ha[LAST_INDEX] || 0 !== ia[LAST_INDEX]), ha, ia, NPCG_INCLUDED = void 0 !== /()??/.exec("")[1], PATCH = UPDATES_LAST_INDEX_WRONG || NPCG_INCLUDED;
    ...
    }), document$1 = _global.document, is = _isObject(document$1) && _isObject(document$1.createElement), _domCreate = function (t) {
    ...
    }, _functionToString = _shared("native-function-to-string", Function.toString), _redefine = createCommonjsModule(function (t) {
    ...
    }, $min = Math.min, $push = [].push, $SPLIT = "split", LENGTH = "length", LAST_INDEX$1 = "lastIndex", MAX_UINT32 = 4294967295, SUPPORTS_Y = !_fails(function () {
    });
    _fixReWks("split", 2, function (r, o, E, v) {
        ...
        return g = "c" == "abbc"[$SPLIT](/(b)*/)[1] || 4 != "test"[$SPLIT](/(?:)/, -1)[LENGTH] || 2 != "ab"[$SPLIT](/(?:ab)*/)[LENGTH] || 4 != "."[$SPLIT](/(.?)(.?)/)[LENGTH] || 1 < "."[$SPLIT](/()()/)[LENGTH] || ""[$SPLIT](/.?/)[LENGTH] ? function (t, e) {
            ...
            var i = _anObject(t), r = String(this), o = _speciesConstructor(i, RegExp), s = i.unicode, a = (i.ignoreCase ? "i" : "") + (i.multiline ? "m" : "") + (i.unicode ? "u" : "") + (SUPPORTS_Y ? "y" : "g"), l = new o(SUPPORTS_Y ? i : "^(?:" + i.source + ")", a), c = void 0 === e ? MAX_UINT32 : e >>> 0;
            if (0 === c)return [];
    ...
    var APP_NAME = "Boilerplate", $document = $(document), $window = $(window), $html = $(document.documentElement).removeClass("has-no-js").addClass("has-js"), $body = $(document.body), $pjaxWrapper = $("#js-pjax-wrapper"), isDebug = !!$html.data("debug"), dP$1 = _objectDp.f, FProto = Function.prototype, nameRE = /^\s*function ([^ (]*)/, NAME = "name";
    ...
    var foreachEls = function (t, e, n) {
        ...
        var e = t.text || t.textContent || t.innerHTML || "", n = t.src || "", i = t.parentNode || document.querySelector("head") || document.documentElement, r = document.createElement("script");
        ...
        outerHTML: function (t, e) {
            ...
            var r = Array.prototype.forEach, o = [], s = [], a = document.createDocumentFragment(), l = "animationend webkitAnimationEnd MSAnimationEnd oanimationend", c = 0, u = function (t) {
    ...
    var uniqueid = (Ye = 0, function () {
        var t = "pjax" + (new Date).getTime() + "_" + Ye;
        return Ye++, t
    }), Ye, trigger = function (e, t, i) {
    ...
    var isDefaultPrevented$1 = function (t) {
        ...
        var t, r = (n = n || {}).requestOptions || {}, o = (r.requestMethod || "GET").toUpperCase(), s = r.requestParams || null, a = r.formData || null, l = null, c = new XMLHttpRequest, u = n.timeout || 0;
        ...
        return _createClass(e, [{
            ...
            key: "hideView", value: function (t, e) {
                isDebug && console.log("----- â?Œ [VIEW]:hide - ", t.getAttribute("data-template")), setTimeout(function () {
            ...
            key: "destroy", value: function () {
                isDebug && console.log("---- â?Œ [transition]:destroy -----")
            }
        }]), e
                    ...
                    var n = function () {
                        ...
                        return e(l, [{
                            ...
                            key: "compareVersions", value: function (t, e) {
                                var n = 2 < arguments.length && void 0 !== arguments[2] && arguments[2], i = l.getVersionPrecision(t), r = l.getVersionPrecision(e), o = Math.max(i, r), s = 0, a = l.map([t, e], function (t) {
                    ...
                    var n = function () {
                        ...
                        return function (t, e) {
                            ...
                            key: "getPlatformType", value: function () {
                                var t = 0 < arguments.length && void 0 !== arguments[0] && arguments[0], e = this.getPlatform(), n = e.type;
                                return t ? String(n).toLowerCase() || "" : n || ""
                            }
                        }, {
                ...
                n = [s, t(17)], void 0 === (i = "function" == typeof(e = function (t, i) {
                    ...
                    var r = /version\/(\d+(\.?_?\d+)+)/i, n = [{
                        test: [/googlebot/i], describe: function (t) {
                            var e = {name: "Googlebot"}, n = i.default.getFirstMatch(/googlebot\/(\d+(\.\d+))/i, t) || i.default.getFirstMatch(r, t);
                            return n && (e.version = n), e
                        }
                    }, {
                        test: [/opera/i], describe: function (t) {
                            var e = {name: "Opera"}, n = i.default.getFirstMatch(r, t) || i.default.getFirstMatch(/(?:opera)[\s\/](\d+(\.?_?\d+)+)/i, t);
                            return n && (e.version = n), e
                        }
                    }, {
                        test: [/opr\/|opios/i], describe: function (t) {
                            var e = {name: "Opera"}, n = i.default.getFirstMatch(/(?:opr|opios)[\s\/](\S+)/i, t) || i.default.getFirstMatch(r, t);
                            return n && (e.version = n), e
                        }
                    }, {
                        test: [/SamsungBrowser/i], describe: function (t) {
                            var e = {name: "Samsung Internet for Android"}, n = i.default.getFirstMatch(r, t) || i.default.getFirstMatch(/(?:SamsungBrowser)[\s\/](\d+(\.?_?\d+)+)/i, t);
                            return n && (e.version = n), e
                        }
                    }, {
                        test: [/Whale/i], describe: function (t) {
                            var e = {name: "NAVER Whale Browser"}, n = i.default.getFirstMatch(r, t) || i.default.getFirstMatch(/(?:whale)[\s\/](\d+(?:\.\d+)+)/i, t);
                            return n && (e.version = n), e
                        }
                    }, {
                        test: [/MZBrowser/i], describe: function (t) {
                            var e = {name: "MZ Browser"}, n = i.default.getFirstMatch(/(?:MZBrowser)[\s\/](\d+(?:\.\d+)+)/i, t) || i.default.getFirstMatch(r, t);
                            return n && (e.version = n), e
                        }
                    }, {
                        test: [/focus/i], describe: function (t) {
                            var e = {name: "Focus"}, n = i.default.getFirstMatch(/(?:focus)[\s\/](\d+(?:\.\d+)+)/i, t) || i.default.getFirstMatch(r, t);
                            return n && (e.version = n), e
                        }
                    }, {
                        test: [/swing/i], describe: function (t) {
                            var e = {name: "Swing"}, n = i.default.getFirstMatch(/(?:swing)[\s\/](\d+(?:\.\d+)+)/i, t) || i.default.getFirstMatch(r, t);
                            return n && (e.version = n), e
                        }
                    }, {
                        test: [/coast/i], describe: function (t) {
                            var e = {name: "Opera Coast"}, n = i.default.getFirstMatch(r, t) || i.default.getFirstMatch(/(?:coast)[\s\/](\d+(\.?_?\d+)+)/i, t);
                            return n && (e.version = n), e
                        }
                    }, {
                        test: [/yabrowser/i], describe: function (t) {
                            var e = {name: "Yandex Browser"}, n = i.default.getFirstMatch(r, t) || i.default.getFirstMatch(/(?:yabrowser)[\s\/](\d+(\.?_?\d+)+)/i, t);
                            return n && (e.version = n), e
                        }
                    }, {
                        test: [/ucbrowser/i], describe: function (t) {
                            var e = {name: "UC Browser"}, n = i.default.getFirstMatch(r, t) || i.default.getFirstMatch(/(?:ucbrowser)[\s\/](\d+(\.?_?\d+)+)/i, t);
                            return n && (e.version = n), e
                        }
                    }, {
                        test: [/Maxthon|mxios/i], describe: function (t) {
                            var e = {name: "Maxthon"}, n = i.default.getFirstMatch(r, t) || i.default.getFirstMatch(/(?:Maxthon|mxios)[\s\/](\d+(\.?_?\d+)+)/i, t);
                            return n && (e.version = n), e
                        }
                    }, {
                        test: [/epiphany/i], describe: function (t) {
                            var e = {name: "Epiphany"}, n = i.default.getFirstMatch(r, t) || i.default.getFirstMatch(/(?:epiphany)[\s\/](\d+(\.?_?\d+)+)/i, t);
                            return n && (e.version = n), e
                        }
                    }, {
                        test: [/puffin/i], describe: function (t) {
                            var e = {name: "Puffin"}, n = i.default.getFirstMatch(r, t) || i.default.getFirstMatch(/(?:puffin)[\s\/](\d+(\.?_?\d+)+)/i, t);
                            return n && (e.version = n), e
                        }
                    }, {
                        test: [/sleipnir/i], describe: function (t) {
                            var e = {name: "Sleipnir"}, n = i.default.getFirstMatch(r, t) || i.default.getFirstMatch(/(?:sleipnir)[\s\/](\d+(\.?_?\d+)+)/i, t);
                            return n && (e.version = n), e
                        }
                    }, {
                        test: [/k-meleon/i], describe: function (t) {
                            var e = {name: "K-Meleon"}, n = i.default.getFirstMatch(r, t) || i.default.getFirstMatch(/(?:k-meleon)[\s\/](\d+(\.?_?\d+)+)/i, t);
                            return n && (e.version = n), e
                        }
                    }, {
                        test: [/micromessenger/i], describe: function (t) {
                            var e = {name: "WeChat"}, n = i.default.getFirstMatch(/(?:micromessenger)[\s\/](\d+(\.?_?\d+)+)/i, t) || i.default.getFirstMatch(r, t);
                            return n && (e.version = n), e
                        }
                    }, {
                        test: [/msie|trident/i], describe: function (t) {
                            var e = {name: "Internet Explorer"}, n = i.default.getFirstMatch(/(?:msie |rv:)(\d+(\.?_?\d+)+)/i, t);
                            return n && (e.version = n), e
                        }
                    }, {
                        test: [/edg([ea]|ios)/i], describe: function (t) {
                            var e = {name: "Microsoft Edge"}, n = i.default.getSecondMatch(/edg([ea]|ios)\/(\d+(\.?_?\d+)+)/i, t);
                            return n && (e.version = n), e
                        }
                    }, {
                        ...
                        test: [/sailfish/i], describe: function (t) {
                            var e = {name: "Sailfish"}, n = i.default.getFirstMatch(/sailfish\s?browser\/(\d+(\.\d+)?)/i, t);
                            return n && (e.version = n), e
                        }
                    }, {
                        ...
                        test: [/blackberry|\bbb\d+/i, /rim\stablet/i], describe: function (t) {
                            var e = {name: "BlackBerry"}, n = i.default.getFirstMatch(r, t) || i.default.getFirstMatch(/blackberry[\d]+\/(\d+(\.?_?\d+)+)/i, t);
                            return n && (e.version = n), e
                        }
                    }, {
                        test: [/(web|hpw)[o0]s/i], describe: function (t) {
                            var e = {name: "WebOS Browser"}, n = i.default.getFirstMatch(r, t) || i.default.getFirstMatch(/w(?:eb)?[o0]sbrowser\/(\d+(\.?_?\d+)+)/i, t);
                            return n && (e.version = n), e
                        }
                    }, {
                        ...
                        test: [/tizen/i], describe: function (t) {
                            var e = {name: "Tizen"}, n = i.default.getFirstMatch(/(?:tizen\s?)?browser\/(\d+(\.?_?\d+)+)/i, t) || i.default.getFirstMatch(r, t);
                            return n && (e.version = n), e
                        }
                    }, {
                        test: [/qupzilla/i], describe: function (t) {
                            var e = {name: "QupZilla"}, n = i.default.getFirstMatch(/(?:qupzilla)[\s\/](\d+(\.?_?\d+)+)/i, t) || i.default.getFirstMatch(r, t);
                            return n && (e.version = n), e
                        }
                    }, {
                        test: [/firefox|iceweasel|fxios/i], describe: function (t) {
                            var e = {name: "Firefox"}, n = i.default.getFirstMatch(/(?:firefox|iceweasel|fxios)[\s\/](\d+(\.?_?\d+)+)/i, t);
                            return n && (e.version = n), e
                        }
                    }, {
                        test: [/chromium/i], describe: function (t) {
                            var e = {name: "Chromium"}, n = i.default.getFirstMatch(/(?:chromium)[\s\/](\d+(\.?_?\d+)+)/i, t) || i.default.getFirstMatch(r, t);
                            return n && (e.version = n), e
                        }
                    }, {
                        test: [/chrome|crios|crmo/i], describe: function (t) {
                            var e = {name: "Chrome"}, n = i.default.getFirstMatch(/(?:chrome|crios|crmo)\/(\d+(\.?_?\d+)+)/i, t);
                            return n && (e.version = n), e
                        }
                    }, {
                        test: function (t) {
                ...
                n = [o, t(17)], void 0 === (r = "function" == typeof(e = function (t, r) {
                    ...
                    var n = [{
                        ...
                        test: [/windows/i], describe: function (t) {
                            var e = r.default.getFirstMatch(/Windows ((NT|XP)( \d\d?.\d)?)/i, t), n = r.default.getWindowsVersionName(e);
                        ...
                        test: function (t) {
                            ...
                            var e = r.default.getFirstMatch(/android[\s\/-](\d+(\.\d+)*)/i, t), n = r.default.getAndroidVersionName(e), i = {
                                name: "Android",
                                version: e
                            };
                ...
                n = [s, t(17)], void 0 === (i = "function" == typeof(e = function (t, i) {
                    ...
                    var r = {tablet: "tablet", mobile: "mobile", desktop: "desktop", tv: "tv"}, n = [{
                        ...
                        test: [/huawei/i], describe: function (t) {
                            var e = i.default.getFirstMatch(/(can-l01)/i, t) && "Nova", n = {
                                type: r.mobile,
                                vendor: "Huawei"
                            };
    ...
    function globals(t) {
        ...
        var r = Bowser.getParser(window.navigator.userAgent), o = "mobile" === r.parsedResult.platform.type || "tablet" === r.parsedResult.platform.type || !1;
    ...
    var max = Math.max, min$1 = Math.min, floor$1 = Math.floor, SUBSTITUTION_SYMBOLS = /\$([$&`']|\d\d?|<[^>]*>)/g, SUBSTITUTION_SYMBOLS_NO_NAMED = /\$([$&`']|\d\d?)/g, maybeToString = function (t) {
    ...
    var _toIobject = function (t) {
        ...
        return o
    }, _enumBugKeys = "constructor,hasOwnProperty,isPrototypeOf,propertyIsEnumerable,toLocaleString,toString,valueOf".split(","), _objectKeys = Object.keys || function (t) {
            return _objectKeysInternal(t, _enumBugKeys)
        }, f$1 = Object.getOwnPropertySymbols, _objectGops = {f: f$1}, f$2 = {}.propertyIsEnumerable, _objectPie = {f: f$2}, $assign = Object.assign, _objectAssign = !$assign || _fails(function () {
    ...
    var EVENT_KEY = "LocomotiveScroll", EVENT$1 = {
        ...
        container: $document, mobileContainer: $document, onScroll: function () {
        }, selector: ".js-animate", smooth: !1, smoothMobile: !1, reversed: !1, getWay: !1, getSpeed: !1
    }, _default$4 = function () {
        function e(t) {
            _classCallCheck(this, e), this.$container = t.container ? t.container : DEFAULTS.container, this.selector = t.selector ? t.selector : DEFAULTS.selector, this.callbacks = {onScroll: "function" == typeof t.onScroll ? t.onScroll : DEFAULTS.onScroll}, this.scroll = {
                x: 0,
                y: 0,
                direction: ""
        ...
        return _createClass(e, [{
            ...
            key: "addElements", value: function () {
                ...
                for (var t = $(this.selector), e = t.length, n = 0; n < e; n++) {
                    var i = t.eq(n), r = i.attr("data-target"), o = i.attr("data-position"), s = r && $(r).length ? $(r) : i, a = s.offset().top, l = a + s.outerHeight(), c = "string" == typeof i.attr("data-sticky"), u = i.attr("data-sticky-target"), d = null;
            ...
            key: "toggleElement", value: function (t, e) {
                var n = !1;
                if (void 0 !== t) {
                    var i = this.scroll.y, r = i + this.windowHeight, o = !1;
            ...
            key: "scrollTo", value: function (t) {
                var e = t.targetElem, n = t.sourceElem, i = t.offsetElem, r = isNumeric(t.targetOffset) ? parseInt(t.targetOffset) : 0, o = isNumeric(t.speed) ? parseInt(t.speed) : 800, s = isNumeric(t.delay) ? parseInt(t.delay) : 0, a = t.toTop, l = t.toBottom, c = 0;
        ...
        return _inherits(n, _default$4), _createClass(n, [{
            ...
            key: "toggleElement", value: function (t, e) {
                var n = !1;
                if (void 0 !== t) {
                    var i = this.instance.scroll.y, r = this.instance.scroll.x, o = i + this.windowHeight, s = r + this.windowWidth, a = !1;
            ...
            key: "scrollTo", value: function (t) {
                var e = t.targetElem, n = t.sourceElem, i = t.offsetElem, r = isNumeric(t.targetOffset) ? parseInt(t.targetOffset) : 0, o = isNumeric(t.speed) ? parseInt(t.speed) : 800, s = isNumeric(t.delay) ? parseInt(t.delay) : 0, a = t.toTop, l = t.toBottom, c = 0, u = t.offset;
                if (void 0 === e && void 0 === n && void 0 === r)return console.warn("You must specify at least one parameter."), !1;
                if (void 0 !== e && e instanceof jQuery && 0 < e.length && (r = e.offset().top + r), void 0 !== n && n instanceof jQuery && 0 < n.length) {
                    var d = "";
        ...
        return t
    }, document$2 = _global.document, _html = document$2 && document$2.documentElement, IE_PROTO$1 = _sharedKey("IE_PROTO"), Empty = function () {
    ...
    var _iterCreate = function (t, e, n) {
    ...
    }, IE_PROTO$2 = _sharedKey("IE_PROTO"), ObjectProto = Object.prototype, _objectGpo = Object.getPrototypeOf || function (t) {
        ...
        }, d = e + " Iterator", h = r == VALUES, f = !1, p = t.prototype, m = p[ITERATOR] || p[FF_ITERATOR] || r && p[r], E = m || u(r), v = r ? h ? u("entries") : E : void 0, g = "Array" == e && p.entries || m;
    ...
    }, toString$1 = Object.prototype.toString, hasOwnProperty$2 = Object.prototype.hasOwnProperty, bindallStandalone = function (t) {
    ...
    var Lethargy = lethargy.Lethargy, EVT_ID = "virtualscroll", src = VirtualScroll, keyCodes = {
        LEFT: 37,
        UP: 38,
        RIGHT: 39,
        DOWN: 40,
    ...
    var _default$6 = function (t) {
        function n(t) {
            var e;
            return _classCallCheck(this, n), (e = _possibleConstructorReturn(this, _getPrototypeOf(n).call(this, t))).isReversed = t.reversed || DEFAULTS$1.reversed, e.getWay = t.getWay || DEFAULTS$1.getWay, e.getSpeed = t.getSpeed || DEFAULTS$1.getSpeed, e.inertia = t.inertia || DEFAULTS$1.inertia, e.parallaxElements = [], e.getSpeed && (e.scroll.speed = 0), e
        }

        return _inherits(n, _default$5), _createClass(n, [{
            key: "init", value: function () {
                var t, i = this;
                $html.addClass("has-smooth-scroll"), this.instance = new src((_defineProperty(t = {
                    mouseMultiplier: 1,
                    touchMultiplier: 1.5
                }, "touchMultiplier", 4), _defineProperty(t, "firefoxMultiplier", 30), t)), this.inertia = .1 * this.inertia, this.instance.scroll = {
                    x: 0,
                    y: 0
                }, this.instance.delta = {x: 0, y: 0}, this.instance.on(function (t) {
                    i.instance.delta.y -= t.deltaY, i.isScrolling = !0, i.instance.delta.y < 0 && (i.instance.delta.y = 0), i.instance.delta.y > i.instance.limit && (i.instance.delta.y = i.instance.limit)
            ...
            key: "addElements", value: function () {
                ...
                for (var t = $(this.selector), e = t.length, n = 0; n < e; n++) {
                    var i = t.eq(n), r = !!i.attr("data-speed") && i.attr("data-speed") / 10, o = (i.attr("data-position"), i.attr("data-target")), s = (i.attr("data-horizontal"), "string" == typeof i.attr("data-sticky")), a = i.attr("data-sticky-target"), l = o && $(o).length ? $(o) : i, c = l.offset().top + this.instance.scroll.y, u = c + l.outerHeight(), d = null;
                    "string" == typeof i.attr("data-viewport-offset") && (d = i.attr("data-viewport-offset").split(","));
                    var h = "string" == typeof i.attr("data-callback") ? i.attr("data-callback") : null, f = null;
                    if (null != h) {
                        for (var p = h.substr(0, h.indexOf("(")), m = h.substr(h.indexOf("("), h.length - p.length), E = (m = (m = m.replace("(", "")).replace(")", "")).split("|"), v = {}, g = 0; g < E.length; g++) {
                    ...
                    if (!1 !== r) {
                        var S = i.attr("data-position"), C = "string" == typeof i.attr("data-horizontal"), A = (u - c) / 2 + c, O = i.attr("data-delay");
                        T.horizontal = C, T.middle = A, T.offset = c, T.position = S, T.speed = r, T.delay = O, this.parallaxElements.push(T)
                    } else T.sticky = s, this.animatedElements.push(T), s && this.toggleElement(T)
                }
            }
        }, {
            key: "render", value: function (t, e) {
                ...
                this.raf = requestAnimationFrame(function () {
                    return n.render()
                }), this.isScrolling ? this.instance.scroll.y = this.lerp(this.instance.scroll.y, this.instance.delta.y, this.inertia) : this.instance.scroll.y = this.lerp(this.instance.scroll.y, this.instance.delta.y, .5 * this.inertia);
                ...
                }), this.getWay && (this.instance.scroll.y > this.scroll.y ? "down" !== this.scroll.direction && (this.scroll.direction = "down") : this.instance.scroll.y < this.scroll.y && "up" !== this.scroll.direction && (this.scroll.direction = "up")), this.getSpeed && (this.scroll.y !== this.instance.scroll.y ? (this.scroll.speed = this.scrollbar.movement.y, this.scroll.y = this.instance.scroll.y) : this.scroll.speed = 0), this.scroll.y !== this.instance.scroll.y && (this.scroll.y = this.instance.scroll.y), this.transformElements(t), this.animateElements()
            }
        }, {
            ...
            key: "scrollTo", value: function (t) {
                var e = this, n = t.targetElem, i = t.sourceElem, r = t.offsetElem, o = isNumeric(t.targetOffset) ? parseInt(t.targetOffset) : 0, s = isNumeric(t.delay) ? parseInt(t.delay) : 0, a = (isNumeric(t.speed) && parseInt(t.speed), t.toTop), l = t.toBottom, c = 0;
                ...
                void 0 !== r && (c = $(r).outerHeight(), o -= c), !0 === a ? o = 0 : !0 === l && (o = this.instance.limit), setTimeout(function () {
                    e.isScrolling = !1, e.instance.delta.y = o
                }, s)
            }
        }, {
            ...
            key: "transformElements", value: function (t) {
                if (0 < this.parallaxElements.length)for (var e = this.instance.scroll.y + this.windowHeight, n = this.instance.scroll.y + this.windowMiddle, i = 0, r = this.parallaxElements.length; i < r; i++) {
                    var o = this.parallaxElements[i], s = !1, a = e + this.windowHeight >= o.offset && this.instance.scroll.y <= o.limit;
            ...
            key: "update", value: function (t) {
                t = t || {}, this.windowHeight = $window.height(), this.windowMiddle = this.windowHeight / 2, this.setScrollLimit(), this.addElements(), this.transformElements(!0)
            }
        }, {
        ...
        return _inherits(e, _default$6), _createClass(e, [{
            key: "init", value: function () {
                ...
                this.isPortrait = !1, window.innerWidth < 1e3 && (this.isPortrait = !0), $html.addClass("has-smooth-scroll"), this.instance = new src({
                    mouseMultiplier: window.isWindows ? 1 : .5,
                    touchMultiplier: window.innerWidth < 1e3 ? 3 : 2,
                    firefoxMultiplier: 30,
                    el: window.isMobile ? window : this.$container[0],
                    useKeyboard: !1
                }), this.inertia = .1 * this.inertia, this.instance.scroll = {x: 0, y: 0}, this.instance.delta = {
                    x: 0,
                    y: 0
                }, this.windowHeight = $window.height(), this.windowMiddleY = this.windowHeight / 2, this.windowWidth = $window.width(), this.windowMiddleX = this.windowWidth / 2, this.instance.on(function (t) {
            ...
            key: "addElements", value: function () {
                this.animatedElements = [], this.parallaxElements = [];
                for (var t = $(this.selector), e = t.length, n = 0; n < e; n++) {
                    var i = t.eq(n), r = !!i.attr("data-speed") && i.attr("data-speed") / 10, o = (i.attr("data-position"), i.attr("data-target")), s = (i.attr("data-horizontal"), "string" == typeof i.attr("data-sticky")), a = i.attr("data-sticky-target"), l = o && $(o).length ? $(o) : i, c = l.offset().top + this.instance.scroll.y, u = l.offset().left + this.instance.scroll.x, d = c + l.outerHeight(), h = u + l.outerWidth(), f = null;
                    ...
                    var T = "string" == typeof i.attr("data-repeat"), S = i.attr("data-inview-class");
                    var elementOffset;
                    void 0 === S && (S = "is-show"), !o && i.attr("data-transform") && (elementOffset -= parseFloat(i.attr("data-transform").y), d = elementOffset + l.outerHeight()), s && (d = void 0 === a ? 1 / 0 : $(a).offset().top - i.height() + this.instance.scroll.y);
                    var C = {
                        $element: i,
                        inViewClass: S,
                        limitY: d,
                    ...
                    if (!1 !== r) {
                        var A = i.attr("data-position"), O = "string" == typeof i.attr("data-horizontal"), N = (d - c) / 2 + c, M = (h - u) / 2 + u, x = i.attr("data-delay");
            ...
            key: "transformElements", value: function (t) {
                if (0 < this.parallaxElements.length)for (var e = this.instance.scroll.y + this.windowHeight, n = this.instance.scroll.x + this.windowWidth, i = this.instance.scroll.y + this.windowMiddleY, r = this.instance.scroll.x + this.windowMiddleX, o = 0, s = this.parallaxElements.length; o < s; o++) {
                    var a = this.parallaxElements[o], l = !1, c = e + this.windowHeight >= a.offsetY && this.instance.scroll.y <= a.limitY;
            ...
            key: "render", value: function (t, e) {
                ...
                }), this.getWay && (this.instance.scroll.y > this.scroll.y ? "down" !== this.scroll.direction && (this.scroll.direction = "down") : this.instance.scroll.y < this.scroll.y && "up" !== this.scroll.direction && (this.scroll.direction = "up")), this.getSpeed && (this.scroll.y !== this.instance.scroll.y ? (this.scroll.speed = this.scrollbar.movement.y, this.scroll.y = this.instance.scroll.y) : this.scroll.speed = 0), this.scroll.y !== this.instance.scroll.y && (this.scroll.y = this.instance.scroll.y), this.scroll.x !== this.instance.scroll.x && (this.scroll.x = this.instance.scroll.x), window.scroll = this.instance.scroll, this.callbacks.onScroll(this.instance, this.$container), this.transformElements(t), this.animateElements()
            }
        }, {
            key: "transformElement", value: function (t, e, n, i, r) {
            ...
            key: "scrollTo", value: function (t) {
                var e = this, n = t.targetElem, i = t.sourceElem, r = t.offsetElem, o = isNumeric(t.targetOffset) ? parseInt(t.targetOffset) : 0, s = isNumeric(t.delay) ? parseInt(t.delay) : 0, a = (isNumeric(t.speed) && parseInt(t.speed), t.toTop), l = t.toBottom, c = 0, u = t.offset, d = this.isReversed ? this.instance.scroll.x : this.instance.scroll.y;
                if (void 0 === n && void 0 === i && void 0 === o)return console.warn("You must specify at least one parameter."), !1;
    ...
    }, EVENT$4 = Object.assign(EVENT$3, {}), DEFAULTS$3 = Object.assign(DEFAULTS$2, {}), MODULE_NAME$1 = "RailMove", EVENT_NAMESPACE$1 = "".concat(APP_NAME, ".").concat(MODULE_NAME$1), EVENT$5 = {
    ...
    }(), MODULE_NAME$3 = "SplittedText", EVENT_NAMESPACE$3 = "".concat(APP_NAME, ".").concat(MODULE_NAME$3), _default$c = function (t) {
        function e(t) {
            return _classCallCheck(this, e), _possibleConstructorReturn(this, _getPrototypeOf(e).call(this, t))
        }
    ...
    }(), MODULE_NAME$4 = "BrandList", EVENT_NAMESPACE$4 = "".concat(APP_NAME, ".").concat(MODULE_NAME$4), EVENT$7 = {
    ...
    }(), MODULE_NAME$5 = "Rail", EVENT_NAMESPACE$5 = "".concat(APP_NAME, ".").concat(MODULE_NAME$5), _default$e = function (t) {
        function n(t) {
            var e;
    ...
    }(), MODULE_NAME$6 = "NavButton", EVENT_NAMESPACE$6 = "".concat(APP_NAME, ".").concat(MODULE_NAME$6), EVENT$8 = {CLICK: "click.".concat(EVENT_NAMESPACE$6)}, CLASS$2 = {
    ...
    }(), MODULE_NAME$7 = "Preloader", EVENT_NAMESPACE$7 = "".concat(APP_NAME, ".").concat(MODULE_NAME$7), _default$g = function (t) {
        function e(t) {
            return _classCallCheck(this, e), _possibleConstructorReturn(this, _getPrototypeOf(e).call(this, t))
        }
        ...
        return _inherits(e, _default$3), _createClass(e, [{
            ...
            key: "destroy", value: function () {
                console.log("â?Œ [module]:destroy - Preloader"), _get(_getPrototypeOf(e.prototype), "destroy", this).call(this), this.$el.off(".".concat(EVENT_NAMESPACE$7))
            }
        }]), e
    ...
    }(), MODULE_NAME$a = "Job", EVENT_NAMESPACE$a = "".concat(APP_NAME, ".").concat(MODULE_NAME$a), EVENT$b = {CLICK: "click.".concat(EVENT_NAMESPACE$a)}, _default$j = function (t) {
        function n(t) {
            var e;
    ...
    }(), MODULE_NAME$b = "Page", EVENT_NAMESPACE$b = "".concat(APP_NAME, ".").concat(MODULE_NAME$b), EVENT$c = {CLICK: "click.".concat(EVENT_NAMESPACE$b)}, _default$k = function (t) {
        function n(t) {
            var e;
        ...
        Job: _default$j,
        Page: _default$k
    }), MODULE_NAME$c = "App", EVENT_NAMESPACE$c = "".concat(APP_NAME, ".").concat(MODULE_NAME$c), EVENT$d = {
        INIT_MODULES: "initModules.".concat(EVENT_NAMESPACE$c),
        INIT_SCOPED_MODULES: "initScopedModules.".concat(EVENT_NAMESPACE$c),
        DELETE_SCOPED_MODULES: "deleteScopedModules.".concat(EVENT_NAMESPACE$c)
    }, App = function () {
        function t() {
            var e = this;
